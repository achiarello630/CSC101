...
y = 5
z = 3
y= 15 #y was = to zero and wasnt able to divide
k = x / y
print(k)
...
y = 20
z = 30
print(x,y,z) #print was indented
...
miles =10
multiplier =1.609344
km = miles * multiplier #multiplier was mispelled as multplier
print(km)
...
z = 2
t = 15
print((x * t) / (y / z)) #the ) was missing
print('Done')

"""Question 5"""

fruit = "kiwi"
print(fruit, fruit, fruit) #fruit was mispelled as frut